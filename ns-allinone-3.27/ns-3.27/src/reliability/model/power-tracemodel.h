...
#ifndef POWER_TRACEMODEL_H
#define POWER_TRACEMODEL_H
...
class PowerTraceModel : public PowerBase// : public DeviceEnergyModel, public LrWpanPhyListener
{
public:
  ...
  virtual void SetSamplingPeriod(const DoubleValue &v0);
  /**
