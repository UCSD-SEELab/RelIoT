...
class MaintainabilityUnit : public MaintainabilityBase
{
public:

  static TypeId GetTypeId (void);
  MaintainabilityUnit ();
  virtual ~MaintainabilityUnit ();
  ...
  void AddDependentUnit (Ptr<MaintainabilityBase> maintenanceUnit);
  void AddRedundantUnit (Ptr<MaintainabilityBase> maintenanceUnit);
