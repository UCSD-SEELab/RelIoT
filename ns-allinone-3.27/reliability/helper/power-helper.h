...
/**
 *
 * \brief helps to manage and create Power objects
 *
...
private:
   ...
   */
  PowerHelper (PowerHelper const &);
  /**
   * \brief Copy constructor - defined and not implemented.
   * \returns
   */
  PowerHelper& operator= (PowerHelper const &);
